...
__global__ void hist_maker (unsigned char *image, int width, int height, int *histogram)
...
int main(){
	string folder_path = "~/cuda-workspace/Cuda/img/";
	string image_path = "smoke10000.jpg";
	...
	//call first kernel
	hist_maker<<<grid_size, block_size>>> (device_image, width, height, device_histogram);
	...
	string save_folder_path = "~/cuda-workspace/Cuda/img_after_eq/";
	string save_image_path = "smoke10000.jpg";
